[![License: CC BY-NC 4.0](https://img.shields.io/badge/License-CC_BY--NC_4.0-lightgrey.svg)](https://github.com/I-NERGY/DeepTSF/blob/master/License.txt)
# DeepTSF
...
This option, however, is not encouraged for everyday use as it rebuilds the conda environment from scratch every time.
...
problem, and switch to that: <br>
    ...
    use case if from_database is set to true. So preferably avoid this step unless you create your own database connection.<br>
